...
export const cropSchema = z.object({
  ...
  establishment: z.array(z.string()).min(1, 'At least one establishment method must be selected'),
  environment: z.array(z.string()).min(1, 'At least one environment must be selected'),
